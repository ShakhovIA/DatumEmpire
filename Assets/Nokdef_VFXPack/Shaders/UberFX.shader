...
Shader "Nokdef/UberFX"
{
	Properties
	{
		[Enum(UnityEngine.Rendering.BlendMode)]_SourceBlendRGB("Blend Mode", Float) = 1
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 clampResult19_g214 = clamp( ( appendResult18_g214 * _DetailDistortionChannel ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				...
				float DistortionNoise90 = clampResult20_g214;
				...
				float4 break2_g215 = ( tex2D( _AlphaOverride, panner44 ) * _AlphaOverrideChannel );
				float AlphaOverride49 = saturate( ( break2_g215.x + break2_g215.y + break2_g215.z + break2_g215.w ) );
				...
				float4 break2_g216 = ( tex2D( _MainTex, panner33 ) * _MainAlphaChannel );
				float MainAlpha30 = saturate( ( break2_g216.x + break2_g216.y + break2_g216.z + break2_g216.w ) );
				...
				#endif
				float4 break17_g217 = tex2DNode79;
				float4 appendResult18_g217 = (float4(break17_g217.x , break17_g217.y , break17_g217.z , break17_g217.w));
				float4 clampResult19_g217 = clamp( ( appendResult18_g217 * _DetailDisolveChannel ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				float4 break2_g217 = clampResult19_g217;
				float clampResult20_g217 = clamp( ( break2_g217.x + break2_g217.y + break2_g217.z + break2_g217.w ) , 0.0 , 1.0 );
				float DisolveNoise275 = clampResult20_g217;
				float4 texCoord258 = i.ase_texcoord1;
				texCoord258.xy = i.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_396_0 = ( ( saturate( step( ( 1.0 - ( staticSwitch198 * DisolveNoise275 ) ) , ( texCoord258.w + 1.0 ) ) ) * staticSwitch198 ) * i.ase_color.a );
				...
				#endif
				float4 break416 = staticSwitch403;
				float4 appendResult415 = (float4(break416.r , break416.g , break416.b , temp_output_396_0));
...
/*ASEBEGIN
Version=18800
2560;0;1920;1029;-896.1826;1804.847;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;357;-286.5385,-2887.257;Inherit;False;Channel Picker;-1;;214;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;27;-3693.025,-1775.166;Inherit;True;Property;_MainTex;Main Texture;1;0;Create;False;0;0;0;False;0;False;None;9e6ef974278de6a44bec7c873e353555;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;165;-2394.869,-2692.418;Inherit;True;Channel Picker Alpha;-1;;215;e49841402b321534583d1dc019041b68;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;164;-2387.532,-2087.719;Inherit;False;Channel Picker Alpha;-1;;216;e49841402b321534583d1dc019041b68;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;223;-3017.38,-617.1442;Inherit;False;Property;_MidColor;Middles;24;0;Create;False;0;0;0;False;0;False;1,0.4447915,0,0;1,0.4447915,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;360;208.4446,-2876.577;Inherit;False;Channel Picker;-1;;217;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;396;991.1122,-955.0929;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;403;1960.215,-2084.408;Inherit;False;Property;_Fresnel;Fresnel;27;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.BreakToComponentsNode;416;2155.535,-1979.544;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;391;1475.463,-1201.305;Inherit;False;Property;_SourceBlendRGB;Blend Mode;0;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;415;2383.395,-1911.763;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;393;-2413.508,-1811.248;Inherit;False;Channel Picker;-1;;218;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;414;2687.572,-2009.4;Float;False;True;-1;2;ASEMaterialInspector;100;1;Nokdef/UberFX;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;1;5;False;391;10;True;391;2;5;False;-1;10;False;-1;True;0;False;391;0;False;-1;False;False;False;False;False;False;True;0;False;-1;True;2;False;418;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;RenderType=Transparent=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;False;0
...
WireConnection;415;1;416;1
WireConnection;415;2;416;2
...
ASEEND*/
//CHKSM=A13F6D202C76CBAD84587FDC8BF877E5B03C4200